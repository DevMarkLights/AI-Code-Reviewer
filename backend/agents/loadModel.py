...
GROQ_MODEL_groq_compound-mini = None
...
if os.getenv("USE_LOCAL") == 'true':
    ...
    GROQ_MODEL_groq_compound-mini = ChatOllama(model="llama3.2:3b", temperature=0, max_tokens=4096)
    ...
    GROQ_MODEL_groq_compound-mini = ChatGroq(model=os.getenv("GROQ_MODEL_groq_compound-mini"), temperature=0, max_tokens=4096)
